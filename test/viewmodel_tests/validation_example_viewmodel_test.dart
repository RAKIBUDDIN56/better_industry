...
void main() {
  group('ValidationExampleViewmodelTest -', () {
    group('canSubmit -', () {
      // test('When constructed canSubmit should be String', () {
      //   var model = ProductProvider();
      //   expect(model.canSubmit, false);
      // });

      test('When changeItemName is called , should be true', () {
        var model = ProductProvider();

        model.changeItemName('Flutter');
